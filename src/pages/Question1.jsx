...
const QuestionOne = () => {
	...
	const [options, setOptions] = useState([
		{ id: 1, value: "Dark Spots", selected: false },
		{ id: 2, value: "Dryness", selected: false },
		{ id: 3, value: "Clogged pores and pimples", selected: false },
		{ id: 4, value: "Dark Circles", selected: false },
		{ id: 5, value: "Acne breakouts", selected: false },
	]);

	const clickHandler = (e, obj) => {
		setQuestions({ ...questions, skinBother: e });
			...
			<div className="h-[100vh] w-[70vw] flex justify-center items-center">
				<div className="h-[50vh] w-[50vw]">
					<div>
						...
						<p className="font-[500] opacity-[0.5] text-[12px]">
