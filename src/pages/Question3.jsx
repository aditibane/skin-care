...
const QuestionThree = () => {
	...
	const [options, setOptions] = useState([
		{ id: 1, value: "Normal", selected: false },
		{ id: 2, value: "Oily", selected: false },
		{ id: 3, value: "Dry", selected: false },
	]);

	const clickHandler = (e, obj) => {
		setQuestions({ ...questions, skin: e });
				...
				<div className="h-[50vh] w-[50vw]">
					<div>
						...
						<p className="font-[500] text-[30px]">
							What kind of skin would you consider yourself to have?
						</p>
