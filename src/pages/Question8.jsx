				...
				<div className="h-[50vh] w-[50vw]">
					<div>
						...
						<p className="font-[500] text-[30px]">
							How have your stress levels been recently? on a scale from 1-10 (1 being
							completely calm and 10 being extremely anxious)?
						</p>
					...
					<div className="flex w-[50vw] justify-center mt-[2rem]">
						<Link
							to={"/9"}
							className="w-[20rem] hover:bg-[#6fb09a] transition text-[20px] font-[500] opacity-[0.9] h-[3rem] bg-[#7BC4AB] text-[#fff] transition border flex items-center justify-center rounded border-[#7BC4AB]"
						>
							NEXT
						</Link>
					</div>
