...
const QuestionEleven = () => {
	...
	const [options, setOptions] = useState([
		{ id: 1, value: "Cleanser", selected: false },
		{ id: 2, value: "Serum", selected: false },
		{ id: 3, value: "Toner", selected: false },
		{ id: 4, value: "Moisturiser", selected: false },
		{ id: 5, value: "Sunscream", selected: false },
		{ id: 6, value: "Eye Cream", selected: false },
		{ id: 7, value: "Face Mask/ Scrub at times", selected: false },
	]);

	const clickHandler = (e, obj) => {
		setQuestions({ ...questions, skinProduct: e });
		...
		<div className="flex">
			<div className="h-[100vh] w-[70vw] flex justify-center items-center">
				<div className="h-[50vh] w-[50vw]">
					<div>
						<p className="text-[#7BC4AB] font-[700] text-[15px]">SKINCARE PRODUCTS</p>
						<p className="font-[500] text-[30px]">
							What skincare products are apart of your routine?
						</p>
								...
								return (
									<button
										...
										className={`w-[20rem] ${
											e.selected
												? "bg-[#7BC4AB] text-[#fff]"
												: "text-[#000] hover:bg-[#7BC4AB] hover:text-[#fff]"
										} text-[12px] opacity-[0.9] h-[3rem]  border rounded transition border-[#7BC4AB]`}
									>
										{e.value}
									</button>
								);
