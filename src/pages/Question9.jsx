...
const QuestionNine = () => {
	...
	const [options, setOptions] = useState([
		{ id: 1, value: "Sugar or Refined Carbs", selected: false },
		{ id: 2, value: "Veggies and Fruits", selected: false },
		{ id: 3, value: "Processed Meats", selected: false },
		{ id: 4, value: "Protiens", selected: false },
		{ id: 5, value: "Dairy", selected: false },
	]);

	const clickHandler = (e, obj) => {
		setQuestions({ ...questions, diet: e });
		...
		<div className="flex">
			<div className="h-[100vh] w-[70vw] flex justify-center items-center">
				<div className="h-[50vh] w-[50vw]">
					<div>
						<p className="text-[#7BC4AB] font-[700] text-[15px]">YOUR DIET</p>
