...
const QuestionThirteen = () => {
	...
	const [options, setOptions] = useState([
		{ id: 1, value: "No", selected: false },
		{ id: 2, value: "Yes", selected: false },
		{ id: 3, value: "Sometimes", selected: false },
	]);

	const clickHandler = (e, obj) => {
		setQuestions({ ...questions, makeupRemove: e });
		...
		<div className="flex">
			<div className="h-[100vh] w-[70vw] flex justify-center items-center">
				<div className="h-[50vh] w-[50vw]">
					<div>
						<p className="text-[#7BC4AB] font-[700] text-[15px]">SKINCARE ROUTINE</p>
						<p className="font-[500] text-[30px]">Do you always remove your makeup?</p>
